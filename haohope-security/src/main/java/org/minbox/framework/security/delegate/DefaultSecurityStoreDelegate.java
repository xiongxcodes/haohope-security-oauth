...
/**
 * The {@link SecurityStoreDelegate} default implement
 * <p>
...
public class DefaultSecurityStoreDelegate implements SecurityStoreDelegate {
     ...
     *
     * @see DefaultSecurityUserDetails
     * @see org.minbox.framework.security.jdbc.DefaultSecurityUserEntity
     */
    ...
    private DefaultSecurityUserDetails findUser(String username) {
        ...
        try {
            ...
            return wrapperOneResult(DefaultSecurityUserDetails.class, resultSet);
        } catch (Exception e) {
